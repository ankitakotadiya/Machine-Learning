...
def mk_cost_lines(x,y,w,b, ax):
    ...
    for p in zip(x,y):
        ...
        ax.annotate(f'{c_p_txt}', xy=cxy, xycoords='data',color=dlpurple,
...
def plt_intuition(x_train, y_train):
    ...
    def func(w=150):
        ...
        ax[1].scatter(w, cur_cost, s=100, color='red', zorder=10, label=f"cost at w={w}")
        ...
        fig.suptitle(f"Minimize Cost: Current Cost = {cur_cost}", fontsize=12)
        plt.show()
